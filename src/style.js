...
export const ANCHOR_STYLES = html`
  a { color: ${COLORS.PRIMARY}; } a:visited { color: ${COLORS.SECONDARY}; }
`;

export const FONT_STYLES = html`
  :host { font-family: "Bitter", serif; color: ${COLORS.PRIMARY}; font-size: 18px; } h1 { font-size:
  24px; color: ${COLORS.PRIMARY}; font-weight: 700; margin: 16px auto 0 auto; } h2 { font-size:
  20px; margin-top: 0; } @media screen and (min-width: 600px) { h1 { font-size: 36px; } h2 {
  font-size: 24px; } }
`;
